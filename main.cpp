...
static const string mainnet_seeds[] = {"vps.zel.network", "vps.runonflux.io", "dnsseed.zel.network", "dnsseed.runonflux.io", ""};
static const string testnet_seeds[] = {"flux-testnet-seed.asoftwaresolution.com",
                                       ""};
